...
import "./extension/AccountPermissions.sol";
import "./extension/ContractMetadata.sol";
import "./external-deps/ERC721Holder.sol";
import "./external-deps/ERC1155Holder.sol";
import "./eip/ERC1271.sol";
import "./extension/Ownable.sol";

// Utils
import "./external-deps/ECDSA.sol";
    ...
    Ownable
{
    ...
    modifier onlyAdminOrEntrypoint() virtual {
        require(
            msg.sender == address(entrypointContract) || isAdmin(msg.sender),
    ...
    function isValidSigner(
        ...
        if (sig == this.execute.selector) {
            ...
            (address target, uint256 value) = decodeExecuteCalldata(
                _userOp.callData
            );
            ...
            if (
                ...
                !data.approvedTargets[_signer].contains(target)
            ) {
    ...
    function isValidSignature(
        ...
        require(
            data.approvedTargets[signer].contains(caller),
